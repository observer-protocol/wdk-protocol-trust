 ...
 * @type {string}
 */
export const DEFAULT_DID_DERIVATION_PATH: string;
/**
 ...
 * @type {string}
 */
export const DID_PREFIX: string;
/**
 ...
 * @type {string}
 */
export const VERIFICATION_METHOD_TYPE: string;
/**
 ...
 */
export const DEFAULT_TRUSTED_ISSUERS: ReadonlyArray<string>;
